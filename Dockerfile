...
RUN python -m pip install matplotlib kagglehub pillow pycuda opencv-python tensorflow[and-cuda] torch torch-tensorrt tensorrt --extra-index-url https://download.pytorch.org/whl/cu124
